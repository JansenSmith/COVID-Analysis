...
## Bias Assessment
<please fill this in, including the explicit list of countries filtered out and use the total Population in Removed_data to determine a "At least X human souls were explicitly removed from this analysis, due to technical difficulties.">